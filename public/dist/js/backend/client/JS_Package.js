function JS_Package(baseUrl, module, controller) {
    this.module = module;
    this.baseUrl = baseUrl;
    this.controller = controller;
    NclLib.menuActive('.link-package');
    NclLib.loadding();
    this.urlPath = baseUrl + '/' + module + '/' + controller;
}
JS_Package.prototype.alerMesage = function(nameMessage,icon,color){
    Swal.fire({
        position: 'top-start',
        icon: icon,
        title: nameMessage,
 ...
 * @return void
 */
JS_Package.prototype.loadIndex = function () {
    var myClass = this;
...
JS_Package.prototype.loadevent = function (oForm) {
    var myClass = this;
    $('form#frmAdd').find('#btn_create').click(function () {
        myClass.store('form#frmAdd');
    })
 ...
 * @return void
 */
JS_Package.prototype.loadList = function (oForm) {
    var myClass = this;
...
//  * @return void
//  */
// JS_Package.prototype.inFor = function (id) {
//     var myClass = this;
//     console.log(id)
//     var url = this.urlPath + '/loadList';
//     var data = $(oForm).serialize();
 ...
 * @return void
 */
JS_Package.prototype.getHuyen = function (codeTinh) {
    var myClass = this;
    ...
    $.ajax({
        ...
        success: function (arrResult) {
            ...
            html += `<select onchange="Package.getXa(this.value)" class="form-control input-sm chzn-select" name="code_huyen" id="code_huyen">`
 ...
 * @return void
 */
JS_Package.prototype.getXa = function (codeHuyen) {
    var myClass = this;
