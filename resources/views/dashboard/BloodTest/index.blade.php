...
@section('body')
    <script type="text/javascript" src="{{ URL::asset('dist\js\backend\pages\JS_BloodTest.js') }}"></script>
    {{-- <link  href="../assets/css/argon-dashboard.css?v=2.0.4" rel="stylesheet" /> --}}
    <div class="container-fluid">
        <div class="row">
            <form action="" method="POST" id="frmBloodTest_index">
    ...
    <script type="text/javascript">
        var baseUrl = '{{ url('') }}';
        var JS_BloodTest = new JS_BloodTest(baseUrl, 'system', 'bloodtest');
        $(document).ready(function($) {
            JS_BloodTest.loadIndex(baseUrl);
        })
    </script>
@endsection
