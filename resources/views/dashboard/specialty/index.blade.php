...
@section('body')
    <script type="text/javascript" src="{{ URL::asset('dist\js\backend\pages\JS_Specialty.js') }}"></script>
    {{-- <link  href="../assets/css/argon-dashboard.css?v=2.0.4" rel="stylesheet" /> --}}
    <div class="container-fluid">
        <div class="row">
            <form action="" method="POST" id="frmSpecialty_index">
    ...
    <script type="text/javascript">
        var baseUrl = '{{ url('') }}';
        var JS_Specialty = new JS_Specialty(baseUrl, 'system', 'specialty');
