                ...
                @php $id = $data['id']; $i = 1; @endphp
                    <tr>
                        <td style="white-space: inherit;vertical-align: middle;">
                            ...
                            <span>Số tiền: {{ isset($data['money']) ? number_format($data['money'],0, '', ',') : '' }} VNĐ </span><br>
                            <span>Chỉ số: <span style="color:red;width:100px">{{ isset($data['code_indications']) ? $data['code_indications'] : '' }}</span> </span><br>
