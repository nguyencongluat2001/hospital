            ...
            <div class="carousel-inner active pt-5">
                <div class="list-hispital-home-one pt-5">
                    <section class="banner-bg">
                        <span class="text-title-home ">
                            <center> ĐẶT LỊCH KHÁM NHANH <br>TẠI CÁC TUYẾN TRUNG ƯƠNG</center>
                        </span>
                    </section>
                </div>
                <!-- End Contact -->
                                                ...
                                                <div class="col-sm-6 col-lg-12 text-decoration-none">
                                                    <div class="pb-3 d-lg-flex gx-5">
                                                        ...
                                                        <form id="frmSpecialty" method="POST" autocomplete="off">
                                                            ...
                                                            <div class="col-lg-12 ">
                                                                <h5 class="title" style="color:#ffd877;font-size: 40px;font-family: serif;font-weight: 600;">Chuyên khoa: {{ !empty($datas->name_specialty)?$datas->name_specialty:'' }}</h5>
