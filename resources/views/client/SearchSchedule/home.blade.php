                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 mx-auto " style="display:flex">
                                            ...
                                            <span class="input-group-btn pt-2" style="padding-left:15px">
                                                <button onclick="JS_SearchSchedule.loadList()" style="font-size: 25px;border-radius: 20%;width: 70px;height: 55px;;background: #ffc000;" type="button" class=" btn-dark" id="txt_search"><i class="fas fa-search"></i></button>
                                            </span>
                                        </div>
                                    </div>
                                </div>
