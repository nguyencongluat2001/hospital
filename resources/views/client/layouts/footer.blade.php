            ...
            <div class="row py-4">
                ...
                <div class="col-lg-3 col-12 align-left">
                    <a class="navbar-brand" href="index.html">
                        ...
                        <div class="image-logo" style="width:34%">
                ...
                <!-- <div class="col-lg-3 col-md-4 my-sm-0 mt-4">
                    <h3 class="h4 pb-lg-3 text-light light-300">HỆ THỐNG LIÊN KẾT</h2>
                        <ul class="list-unstyled text-light light-300">
                            ...
                            <li class="pb-2">
                                <i class='bx-fw bx bxs-chevron-right bx-xs'></i></i><a class="text-decoration-none text-light py-1" href="{{ url('/facilities') }}">Xem thêm</a>
                            </li>
                        </ul>
                </div> -->

                <div class="col-lg-6 col-md-4 my-sm-0 mt-4">
                    <h2 class="h4 pb-lg-4 text-light light-300">LỊCH LÀM VIỆC</h2>
                    <ul class="list-unstyled text-light light-300">
                        <li class="pb-2">
                            <i class='bx-fw bx bxs-chevron-right bx-xs'></i><a class="text-decoration-none text-light py-1" href="#">Lấy máu <br> Thứ 2 - Thứ Chủ nhật | 7:00 - 21:00 Nhân viên trực tư vấn 24/7 lấy máu</a></a>
                        </li>
                        <li class="pb-2">
                            <i class='bx-fw bx bxs-chevron-right bx-xs'></i><a class="text-decoration-none text-light py-1" href="#">Truyền dịch <br> Thứ 2 - Thứ Chủ nhật | 7:00 - 21:00 Nhân viên trực tư vấn 24/7 truyền dịch</a></a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-lg-3 col-md-4 my-sm-0 mt-4">
                    ...
                    <ul class="list-unstyled text-light light-300">
                         <li class="pb-2">
                            <i class='bx-fw bx bx-phone bx-xs'></i><a class="text-decoration-none text-light py-1" href="tel:02439935556">CÔNG TY TNHH DỊCH VỤ Y TẾ <br> MEDHANOI </a>
                        </li>
                        <li class="pb-2">
